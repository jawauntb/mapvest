...
export const elevation = {
  sm: { shadowColor: "#000", shadowOpacity: 0.24, shadowRadius: 2, shadowOffset: { width: 0, height: 1 }, elevation: 2 },
  md: { shadowColor: "#000", shadowOpacity: 0.3, shadowRadius: 8, shadowOffset: { width: 0, height: 4 }, elevation: 6 },
  lg: { shadowColor: "#000", shadowOpacity: 0.36, shadowRadius: 20, shadowOffset: { width: 0, height: 10 }, elevation: 12 },
} as const;
