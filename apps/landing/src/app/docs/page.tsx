...
export const metadata: Metadata = {
  title: 'Docs',
  description:
    'Architecture, data sources, secrets, deploy, and system-design notes for Mapvest.',
};
  ...
  return (
    <section className="section container">
      ...
      <p className="section__lead">
        Design docs, architecture, and operational notes — rendered from the
        markdown files that live in <code>docs/</code> in the repo. Edit the
        source, redeploy the site, and this page updates itself.
      </p>

      {docs.length === 0 ? (
        <p style={{ color: 'var(--fg-dim)' }}>
          No documentation files found. Add markdown files to <code>docs/</code>
          {' '}in the repo root.
        </p>
      ) : (
